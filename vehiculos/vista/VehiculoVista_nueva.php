...
class VehiculoVista extends vista
{
    ...
    public function preguntarDatosPlaca($placa,$propietarios){
        ...
        <div class="row">
                <div class="col-lg-6">
                    <label class="col-lg-2">Placa:</label>
                    <div class="col-lg-4">
                        <input type="text" id="placa" onfocus="blur();" value = "<?php echo $placa ?>" style="background-color:gray; color:white;"  class="form-control">
                    </div>
                </div>
                
                <div class="col-lg-6">
                    <label class="col-lg-2">Propietario:</label>
                    <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-lg-6">
                    <label class="col-lg-2">Marca_:</label>
                    <div class="col-lg-4">
                        <input type="text" id="marca" style="background-color:gray; color:white;"  class="form-control">
                    </div>
            </div>
                
                <div class="col-lg-6">
                    <label>Linea_:</label>
                    <input type="text" id="linea" style="background-color:gray; color:white;" class="form-control">
                </div>
        </div>
        ...
        <div class="row">
                <div class="col-lg-6">
                    <label>Modelo_:</label>
                    <input type="text" id="modelo" style="background-color:gray; color:white;"  class="form-control">
                </div>

                <div class="col-lg-6">
                    <label>Color_:</label>
                    <input type="text" id="color" style="background-color:gray;color:white;" class="form-control">
                </div>
