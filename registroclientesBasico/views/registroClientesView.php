...
class registroClientesView extends vista
{
    ...
    public function pantallaInicialRegistroCliente()
    {
        ...
        <script src="../registroclientesBasico/js/registro.js"></script>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="d-grid gap-2">
                    <button id="btnRegistrar" class="btn btn-primary btn-lg btn-block mt-3" onclick = "registrarClienteBasico();">Registrar</button>
                </div>
        </div>
    ...
    public function muestreInfoCliente($infoCliente)
    {
        ...
        <div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <label>Identi: </label>
                    <input type="text"   class="form-control" onFocus="blur();" value = "<?php echo $infoCliente['identi']   ?>">
                </div>
                <div class="col-lg-6">
                    <label>Nombre: </label>
                    <input type="text"   class="form-control" onFocus="blur();" value = "<?php echo $infoCliente['nombre']   ?>">
                </div>
                <div class="col-lg-6">
                    <label>Celular: </label>
                    <input type="text"   class="form-control" onFocus="blur();" value = "<?php echo $infoCliente['telefono']   ?>">
                </div>
                <div class="col-lg-6">
                    <label>Email: </label>
                    <input type="text"   class="form-control" onFocus="blur();" value = "<?php echo $infoCliente['email']   ?>">
                </div>
            </div>
